...
const LinkConteiner: FC<TLinkConteiner> = ({ path, text, children, width, contentPosition, isBgColorChange, isActive, leftPadding }) => {

    return (

        <LinkElement width={width} contentPosition={contentPosition} isActive={isActive} isBgColorChange={isBgColorChange} leftPadding={leftPadding} >
