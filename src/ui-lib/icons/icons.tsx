...
export const HeartsFullIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const CloseIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const DawIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const HeartIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const HomeIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const LoginIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const MinusIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const PlusIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const ExitIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const BasketIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
...
export const ClipIcon: FC<Ticons> = ({
  onClick, width, height, isHover, onBlur, cursor, color,
}) => (
