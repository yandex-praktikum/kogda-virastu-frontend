...
import { Divider, OpenMenuButton } from '../ui-lib';
...
const Header: FC = () => {
  ...
  const TextContainer = styled.div`
    ...
    border-bottom: 1px solid ${theme.primaryText};
    @media screen and (max-width:1300px) {
  ...
  const MainText = styled.h1`
    font: ${theme.text118Sans.weight} ${theme.text118Sans.size}px/${theme.text118Sans.height}% ${theme.text118Sans.family};
    margin: 0;
    padding: 0;
    @media screen and (max-width:1300px) {
      font-size: ${theme.text102Sans.size}px;
    }
    @media screen and (max-width:1023px) {
      font-size: ${theme.text86Sans.size}px;
    }
    @media screen and (max-width:720px) {
      font-size: ${theme.text40Sans.size}px;
    }
  `;

  const TagLine = styled.p`
    font: ${theme.text26SubSans.weight} ${theme.text26SubSans.size}px/${theme.text26SubSans.height}% ${theme.text26SubSans.family};
    max-width: 225px;
    margin: 0;
    padding: 22px 0 0 0;
    @media screen and (max-width:1300px) {
      font-size: ${theme.text18SubSans.size}px;
      max-width: 156px;
    }
    @media screen and (max-width:1023px) {
      padding: 18px 0 0 0;
    ...
    @media screen and (max-width:720px) {
      font-size: ${theme.text16SubSans.size}px;
      max-width: 139px;
      padding: 0;
    }
  `;
